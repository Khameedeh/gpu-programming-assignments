...
// BUG FIX: Changed 'if' to 'while' to handle spurious wakeups correctly
void* producer(void* arg) {
    ...
    for (int i = 0; i < ITEMS_TO_PRODUCE; i++) {
        ...
        // FIX: Changed from if to while - prevents spurious wakeup issues
        // If woken up spuriously, the condition will be re-checked
